...
[![Version](https://img.shields.io/badge/version-1.3.0-blue.svg)](https://github.com/hisoka-root/rsstoat/releases)
[![License: MPL 2.0](https://img.shields.io/badge/License-MPL_2.0-brightgreen.svg)](https://opensource.org/licenses/MPL-2.0)

Desktop client for [Stoat](https://stoat.chat) chat, built with [Tauri v2](https://v2.tauri.app).

**Version** 1.3.0 &middot; A port of the Stoat desktop client from **Electron** to **Tauri v2** (Rust backend, smaller bundles).
